...
```bash
sh -c "$(wget -qO- https://raw.githubusercontent.com/DomHoney/dotfiles/HEAD/scripts/install_dotfiles.sh)"
```

> 💡 We use `wget` here because it comes preinstalled with most Ubuntu versions. But you can also use `curl`:
>
> ```bash
>  sh -c "$(curl -fsSL https://raw.githubusercontent.com/DomHoney/dotfiles/HEAD/scripts/install_dotfiles.sh)"
> ```
...
```console
DOTFILES_BRANCH=beta sh -c "$(wget -qO- https://raw.githubusercontent.com/DomHoney/dotfiles/HEAD/scripts/install_dotfiles.sh)"
```
...
- [`README.md`](./README.md)
  - Replace all occurrences of `https://raw.githubusercontent.com/DomHoney/dotfiles/HEAD/scripts/install_dotfiles.sh` with `https://raw.githubusercontent.com/<your-username>/dotfiles/HEAD/scripts/install_dotfiles.sh`
